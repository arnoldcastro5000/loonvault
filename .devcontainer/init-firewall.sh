...
# Lock DNS to a specific resolver only
...
# Build domain list from hardcoded set plus optional extra-domains file
EXTRA_DOMAINS_FILE="/workspace/.devcontainer/firewall-extra-domains.txt"
extra_domains=()
...
# Reject all other outbound traffic with immediate feedback
